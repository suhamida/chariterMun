...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}back/assets/images/brand/favicon.ico" />

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="{{asset('/')}}back/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    ...
    <link href="{{asset('/')}}back/assets/switcher/css/switcher.css" rel="stylesheet">
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="mt-1">
                                        <a class="bg-img bg-img1" href="javascript:void(0);"><img
                                                src="{{asset('/')}}back/assets/images/media/bg-img1.jpg" alt="Bg-Image" id="bgimage1"></a>
                                        <a class="bg-img bg-img2" href="javascript:void(0);"><img
                                                src="{{asset('/')}}back/assets/images/media/bg-img2.jpg" alt="Bg-Image" id="bgimage2"></a>
                                        <a class="bg-img bg-img3" href="javascript:void(0);"><img
                                                src="{{asset('/')}}back/assets/images/media/bg-img3.jpg" alt="Bg-Image" id="bgimage3"></a>
                                        <a class="bg-img bg-img4" href="javascript:void(0);"><img
                                                src="{{asset('/')}}back/assets/images/media/bg-img4.jpg" alt="Bg-Image" id="bgimage4"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div id="global-loader">
    <img src="{{asset('/')}}back/assets/images/loader.svg" class="loader-img" alt="Loader">
</div>
<!-- /GLOBAL-LOADER -->
...
<script src="{{asset('/')}}back/assets/plugins/p-scroll/perfect-scrollbar.js"></script>
<script src="{{asset('/')}}back/assets/plugins/p-scroll/pscroll.js"></script>
...
<!-- CHART-CIRCLE JS-->
<script src="{{asset('/')}}back/assets/plugins/circle-progress/circle-progress.min.js"></script>

<!-- INTERNAL DATA-TABLES JS-->
<script src="{{asset('/')}}back/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
<script src="{{asset('/')}}back/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
...
<!-- Reply JS-->
<script src="{{asset('/')}}back/assets/js/reply.js"></script>


<!-- COLOR THEME JS -->
<script src="{{asset('/')}}back/assets/js/themeColors.js"></script>
